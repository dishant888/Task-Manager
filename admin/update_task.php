...
mysqli_query($con,"insert into history(team_id,project_id,task_row_id,status,description,spent_hrs,created_date) values($by,$id,$task_row_id,'$status','$description',$hours,'$date')");
